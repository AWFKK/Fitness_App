...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget(languages.lblHome, context: context, showBack: false, titleSpacing: 16, actions: [
        Image.asset(ic_notification, height: 25, width: 25, color: primaryColor).onTap(() {
